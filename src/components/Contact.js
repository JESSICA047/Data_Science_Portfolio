...
export default function Contact() {
  ...
  const yourEmail = "jadzoyi.work@gmail.com";
  ...
  return (
    <section id="contact" ref={contactSectionRef}>
      ...
      <div className="contact-intro">
        <p>
          I'm currently exploring opportunities in data analysis and data
          science, and I'm always open to connecting with like-minded
          professionals. If you have a role, project, or collaboration in mind,
