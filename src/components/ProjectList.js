  ...
  SQL: [
    {
      ...
      files: [
        ...
        },
        {
          name: "cleaning.sql",
          type: "code",
          content: Code("Cyclistic").cleaning,
          language: "sql",
        },
        {
          name: "querying.sql",
          type: "code",
          content: Code("Cyclistic").querying,
          language: "sql",
        },
        {
          name: "viz_query.sql",
          type: "code",
          content: Code("Cyclistic").viz_query,
          language: "sql",
        },
      ],
    },

    {
      ...
      github: "https://github.com/JESSICA047/Data-Cleaning-MySQL",
...

    {
      ...
      github: "https://github.com/JESSICA047/Covid-Data-Exploration-Project",
  ...
  Python: [
    {
      ...
      github:
        "https://github.com/JESSICA047/Movie-Correlation---Pandas-NumPy-SNS",
      ...
      files: [
        ...
        },
        {
          ...
          type: "notebook",
          content:
            "https://nbviewer.org/github/JESSICA047/Movie-Correlation---Pandas-NumPy-SNS/blob/main/Finding%20Movie%20Correlation.ipynb?flush_cache=true",
          language: "python",
        },
      ],
    },

    {
      ...
      github:
        "https://github.com/JESSICA047/Automating-Crypto-Data-using-CoinGecko-API",
      ...
      files: [
        ...
        },
        {
          ...
          type: "notebook",
          content:
            "https://nbviewer.org/github/JESSICA047/Automating-Crypto-Data-using-CoinGecko-API/blob/main/Automating%20Crypto%20-%20CoinGecko%20API.ipynb?flush_cache=true",
          language: "python",
        },
      ],
    },

    {
      ...
      github: "https://github.com/JESSICA047/Amazon-Web-Scraping",
      ...
      files: [
        ...
        },
        {
          ...
          type: "notebook",
          content:
            "https://nbviewer.org/github/JESSICA047/Amazon-Web-Scraping/blob/main/Amazon%20Web%20Scraping%20-%20Data%20Project.ipynb?flush_cache=true",
          language: "python",
        },
      ],
    },
  ...
  Tableau: [
    {
      ...
      medium:
        "https://medium.com/@jessicaadzoyi04/from-data-to-insights-googles-cyclistic-case-study-04fb362c2d0d",
      tableau:
        "https://public.tableau.com/app/profile/jessica.adzoyi/viz/GoogleCyclisticCaseStudyVisualization/DashboardMain",
...

    {
      ...
      tableau:
        "https://public.tableau.com/app/profile/jessica.adzoyi/viz/CovidDataVisualizationDashboard-May2024/Dashboard1",
      tags: ["Tableau", "Data Visualization"],
      files: [
        {
          name: "README.md",
